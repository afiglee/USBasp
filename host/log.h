...
public:
  ...
  template <typename T> friend _debug &operator<<(_debug &me, const T &value) {
...
public:
  ...
  template <typename T> friend _info &operator<<(_info &me, const T &value) {
...
public:
  ...
  template <typename T> friend _error &operator<<(_error &me, const T &value) {
